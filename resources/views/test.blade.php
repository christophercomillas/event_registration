...
<!-- https://colorlib.com//polygon/admindek/default/index.html -->
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('images/temp.png') }}" type="image/x-icon">
            ...
            <div class="pcoded-container navbar-wrapper">
                    ...
                    <div class="navbar-wrapper">
                        ...
                        <div class="navbar-container container-fluid">
                            <ul class="nav-left">
                                ...
                                <li>
                                    <a href="#!" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:toggleFullScreen()" class="waves-effect waves-light" data-cf-modified-0290a0bc63e28c03fd9b4ab5-="">
                ...
                <div class="showChat_inner">
                    <div class="media chat-inner-header">
                        ...
                        <i class="feather icon-x"></i> Josephin Doe</a>
                    </div>
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        ...
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                ...
                                                <li class="">
                                                    <a href="widget-data.html" class="waves-effect waves-dark"> <span class="pcoded-mtext">Data</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                ...
                                                <li class=" ">
                                                    <a href="color.html" class="waves-effect waves-dark"> <span class="pcoded-mtext">Color</span>
                                                    </a>
                                                </li>
                                                <li class=" ">
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                ...
                                                <li class="">
                                                    <a href="chart-chartjs.html" class="waves-effect waves-dark"> <span class="pcoded-mtext">ChartJs</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                                ...
                                                                <div class="latest-update-box">
                                                                    <div class="row p-t-20 p-b-30">
                                                                        <div class="col-auto text-right update-meta p-r-0">
                                                                            <img src="{{ asset('images/avatar-4.jpg') }}" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
                                                                        </div>
                                                                        <div class="col p-l-5">
                                                                            <a href="#!">
                                                                ...
                                                                <div class="latest-update-box">
                                                                    <div class="row p-t-20 p-b-30">
                                                                        ...
                                                                        <div class="col p-l-5">
                                                                            ...
                                                                            <p class="text-muted m-b-0">Lorem ipsum dolor sit amet, <a href="#!" class="text-c-blue"> More</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row p-b-30">
                                                                        ...
                                                                        <div class="col p-l-5">
                                                                            ...
                                                                            <p class="text-muted m-b-0">Lorem dolor sit amet, <a href="#!" class="text-c-blue"> More</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row p-b-30">
                                                                        ...
                                                                        <div class="col p-l-5">
                                                                            ...
                                                                            <p class="text-muted m-b-0">Lorem ipsum dolor sit ipsum amet, <a href="#!" class="text-c-green"> More</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row p-b-30">
                                                                        ...
                                                                        <div class="col p-l-5">
                                                                            ...
                                                                            <p class="text-muted m-b-0">Lorem ipsum dolor sit amet, <a href="#!" class="text-c-red"> More</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row p-b-30">
                                                                ...
                                                                <table class="table table-hover m-b-0">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Sofa</td>
                                                                            <td>#PHD001</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="58393a3b183f35393134763b3735">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Computer</td>
                                                                            <td>#PHD002</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dfbcbbbc9fb8b2beb6b3f1bcb0b2">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Mobile</td>
                                                                            <td>#PHD003</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="93e3e2e1d3f4fef2faffbdf0fcfe">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                                <label class="label label-danger">Out Stock</label>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Coat</td>
                                                                            <td>#PHD004</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3d5f5e4e7d5a505c5451135e5250">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                                <label class="label label-success">In Stock</label>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Watch</td>
                                                                            <td>#PHD005</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a3c0c7c0e3c4cec2cacf8dc0ccce">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                                <label class="label label-success">In Stock</label>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Shoes</td>
                                                                            <td>#PHD006</td>
                                                                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2252535062454f434b4e0c414d4f">[email&#160;protected]</a>
                                                                            </td>
                                                                            <td>
                                                                                <label class="label label-danger">Out Stock</label>
                                                                            </td>
